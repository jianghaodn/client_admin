...
const routes = [
	...
	// 配送信息路由
	{
		path: '/distribution_information/table',
		name: 'distribution_information_table',
		component: () => import('../views/distribution_information/table.vue')
	},
	{
		path: '/distribution_information/view',
		name: 'distribution_information_view',
		component: () => import('../views/distribution_information/view.vue')
	},
	// 退货信息路由
	{
	...
	// 商品类别路由
	{
		path: '/commodity_category/table',
		name: 'commodity_category_table',
		component: () => import('../views/commodity_category/table.vue')
	},
	{
		path: '/commodity_category/view',
		name: 'commodity_category_view',
		component: () => import('../views/commodity_category/view.vue')
	},
