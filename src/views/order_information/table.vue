<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/order_information/table','add') || $check_action('/order_information/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/order_information/table','del') || $check_action('/order_information/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="subscriber_telephone" label="用户电话"
				v-if="user_group == '管理员' || $check_field('get','subscriber_telephone')" min-width="200">
			</el-table-column>
			<el-table-column prop="user_address" label="用户地址"
			...
			<el-table-column prop="commodity_price_" label="商品价钱"
				v-if="user_group == '管理员' || $check_field('get','commodity_price_')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/order_information/table','set') || $check_action('/order_information/view','set') || $check_action('/order_information/view','get') || $check_action('/配送|退货/table','add') || $check_action('/配送|退货/view','add')" >
				...
				<template slot-scope="scope">
					...
					<!--跨表按钮-->
					<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/distribution_information/view')" v-if="user_group == '管理员' || $check_action('/distribution_information/table','add') || $check_action('/distribution_information/view','add')">
						<span>配送</span>
					</el-button>
