		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','subscriber_telephone') || $check_field('add','subscriber_telephone') || $check_field('set','subscriber_telephone')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="用户电话" prop="subscriber_telephone">
					<el-input id="subscriber_telephone" v-model="form_sub['subscriber_telephone']" placeholder="请输入用户电话" type="tel"
						v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','subscriber_telephone')) || (!form_sub['ordinary_users_id'] && $check_field('add','subscriber_telephone'))">
					</el-input>
					<div v-else-if="$check_field('get','subscriber_telephone')">{{form_sub['subscriber_telephone']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','user_address') || $check_field('add','user_address') || $check_field('set','user_address')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="用户地址" prop="user_address">
					<el-input id="user_address" v-model="form_sub['user_address']" placeholder="请输入用户地址"
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','user_address')) || (!form_sub['ordinary_users_id'] && $check_field('add','user_address'))"></el-input>
					<div v-else-if="$check_field('get','user_address')">{{form_sub['user_address']}}</div>
				</el-form-item>
			</el-col>
			<el-col :xs="24" :sm="12" :lg="8">
				<el-form-item>
