<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="24" :lg="8">
					<el-form-item label="商品类型">
						<el-select v-model="query.commodity_type">
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/product_information/table','add') || $check_action('/product_information/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/product_information/table','del') || $check_action('/product_information/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="product_cover" label="商品封面"
			...
			<el-table-column prop="merchandise_inventory" label="商品库存"
				v-if="user_group == '管理员' || $check_field('get','merchandise_inventory')" min-width="200">
			</el-table-column>
			...
			<el-table-column prop="product_description" label="商品描述"
				v-if="user_group == '管理员' || $check_field('get','product_description')" min-width="200">
			</el-table-column>
