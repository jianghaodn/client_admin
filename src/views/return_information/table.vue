<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/return_information/table','add') || $check_action('/return_information/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/return_information/table','del') || $check_action('/return_information/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="return_request_" label="退货申请"
				v-if="user_group == '管理员' || $check_field('get','return_request_')" min-width="200">
			</el-table-column>
			<el-table-column prop="collection_account_number" label="收款账号"
				v-if="user_group == '管理员' || $check_field('get','collection_account_number')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/return_information/table','set') || $check_action('/return_information/view','set') || $check_action('/return_information/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
